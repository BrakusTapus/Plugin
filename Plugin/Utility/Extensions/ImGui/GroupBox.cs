...
public static partial class ImGuiExt
{
    ...
    public static bool BeginGroupBox(string id = null, float minimumWindowPercent = 1.0f, GroupBoxOptions options = null)
    {
        ...
        var contentRegionWidth = groupBoxOptionsStack.TryPeek(out var parent) ? parent.Width - parent.BorderPadding.X * 2 : ImGui.GetContentRegionAvail().X - style.WindowPadding.X;
