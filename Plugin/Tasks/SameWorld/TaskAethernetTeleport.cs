...
internal static class TaskAethernetTeleport
{
    ...
    {
        if(P.EzConfigs.WaitForScreenReady) P.TaskManager.Enqueue(Utils.WaitForScreen);
        ...
        P.TaskManager.EnqueueDelay(P.EzConfigs.SlowTeleport ? P.EzConfigs.SlowTeleportThrottle : 0);
