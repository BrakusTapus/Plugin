...
{
    /// <summary> Example of a method to draw a label with custom color </summary>
    ...
    /// <summary> ColorPicker with palette. </summary>
    ...
    /// <summary> Alpha modified IconButton component to use an icon as a button with alpha and color options. </summary>
    ...
    /// <summary> Alpha modified Button component to use as a disabled button with alpha and color options. </summary>
    ...
    /// <summary> Draw a disabled toggle button. </summary>
    /// <param name="id"> The id of the button. </param>
    ...
    /// <summary> HelpMarker component to add a help icon with text on hover. </summary>
    ...
    /// <summary> HelpMarker component to add a custom icon with text on hover. </summary>
    /// <param name="helpText"> The text to display on hover. </param>
    ...
    /// <summary> IconButton component to use an icon as a button. </summary>
    /// <param name="icon"> The icon for the button. </param>
    /// <returns> Indicator if button is clicked. </returns>
    ...
    /// <summary> IconButton component to use an icon as a button with color options. </summary>
    /// <param name="id">           The ID of the button. </param>
    /// <param name="icon">         The icon for the button. </param>
    /// <param name="defaultColor"> The default color of the button. </param>
    /// <param name="activeColor">  The color of the button when active. </param>
    ...
    /// <summary> Test component to demonstrate how ImGui components work. </summary>
    public static void Test()
    {
        ImGui.Text("You are viewing the test component. The test was a success.");
    }

    /// <summary> TextWithLabel component to show labeled text. </summary>
    ...
    /// <summary> Draw a toggle button. </summary>
    /// <param name="id"> The id of the button. </param>
    /// <param name="v">  The state of the switch. </param>
    ...
    /// <summary> Get width of IconButtonWithText component. </summary>
