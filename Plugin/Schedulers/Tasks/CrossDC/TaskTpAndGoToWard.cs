...
//using Plugin.Tasks.Utility;
//using Lumina.Excel.GeneratedSheets;
//using System.Linq;
//using Action = Lumina.Excel.GeneratedSheets.Action;
////using ResidentialAetheryteKind = Plugin.ResidentialAetheryteKind;
...
//        if(ECommons.GameHelpers.Player.CurrentWorld != world)
//        {
//            if(P.DataStore.Worlds.TryGetFirst(x => x.StartsWith(world == "" ? Plugin.Utilities.Player.HomeWorld : world, StringComparison.OrdinalIgnoreCase), out var w))
//            {
//                P.TPAndChangeWorld(w, false, null, true, gateway, false, gateway != null);
//            }
//            else if(P.DataStore.DCWorlds.TryGetFirst(x => x.StartsWith(world == "" ? Plugin.Utilities.Player.HomeWorld : world, StringComparison.OrdinalIgnoreCase), out var dcw))
//            {
...
//    public static Plugin.Utilities.Enums.WorldChangeAetheryte? DetermineGatewayAetheryte(ResidentialAetheryteKind targetZone)
//    {
//        if(targetZone == ResidentialAetheryteKind.Uldah) return Plugin.Utilities.Enums.WorldChangeAetheryte.Uldah;
//        if(targetZone == ResidentialAetheryteKind.Gridania) return Plugin.Utilities.Enums.WorldChangeAetheryte.Gridania;
//        if(targetZone == ResidentialAetheryteKind.Limsa) return Plugin.Utilities.Enums.WorldChangeAetheryte.Limsa;
//        return null;
//    }
//}
