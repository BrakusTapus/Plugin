...
//namespace Plugin.Schedulers.Handlers;

//internal static unsafe class RetainerHandlers
//{
//    internal static bool? ConfirmCantBuyback()
//    {
//        var yesno = Utils.GetSpecificYesno("Your retainer will be unable to process item buyback requests once recalled. Are you sure you wish to proceed?");
//        if (yesno != null)
//        {
